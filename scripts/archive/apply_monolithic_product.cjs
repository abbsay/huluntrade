...
// We will precisely replace the whole return block inside ProductDetail
const returnIndex = code.indexOf('  return (\n    <main className={`min-h-[90vh] bg-gradient-to-b ${theme.bg}');
if (returnIndex === -1) {
...
const newReturnBlock = `  return (
    <main className={\`min-h-[90vh] bg-gradient-to-b \${theme.bg} pt-32 md:pt-40 pb-32 relative overflow-hidden\`}>
          ...
          <div className="w-full lg:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
            ...
            >
              ...
              >
                <Link
                  to="/contact"
                  className={\`flex items-center justify-center w-full sm:w-auto px-10 py-5 rounded-full font-black text-[17px] shadow-xl jelly-highlight transition-all duration-300 text-white \${theme.btn} \${theme.shadow}\`}
                >
